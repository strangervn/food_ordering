...
import com.example.appfoodv2.Presenter.IProduct;
...
public class ProductActivity extends AppCompatActivity {
    ...
    private ArrayList<ProductModels> arr_sp = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productModels = new ProductModels(new IProduct() {
            @Override
        ...
        dialog.show();
        productModels.HandlegetDataSanPhamAll();

        findViewById(R.id.image_add).setOnClickListener(view -> {
            startActivityForResult(new Intent(ProductActivity.this, com.example.appfoodv2.ProductActivity.class), 100);
        });
    }
