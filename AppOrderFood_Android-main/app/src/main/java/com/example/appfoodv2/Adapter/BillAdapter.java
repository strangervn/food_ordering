...
public class BillAdapter extends RecyclerView.Adapter<BillAdapter.ViewHodler> {
    private Context context;
    private ArrayList<BillModels> arrayList;
    private  int type = 0;

    public BillAdapter(Context context, ArrayList<BillModels> arrayList) {
        this.context = context;
        this.arrayList = arrayList;
    }
    public BillAdapter(Context context, ArrayList<BillModels> arrayList, int type) {
        this.context = context;
        this.arrayList = arrayList;
        this.type= type;
    }
    ...
    @NonNull
    @Override
    public BillAdapter.ViewHodler onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view;
        if(type==0 || type==5){
    ...
    @Override
    public void onBindViewHolder(@NonNull BillAdapter.ViewHodler holder, int position) {
