...
public class ProductModels implements Serializable {
    ...
    public ProductModels(IProduct callback) {
        this.callback = callback;
        db= FirebaseFirestore.getInstance();
    }

    public ProductModels(String id, String id_sp, String tensp, long giatien, String hinhanh, String loaisp, long soluong, String hansudung, long type, String trongluong) {
        this.id = id;
        this.tensp = tensp;
    ...
    public ProductModels(String id, String tensp, long giatien, String hinhanh, String loaisp, String mota, long soluong, String hansudung,
