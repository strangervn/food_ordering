...
import com.example.appfoodv2.Adapter.BillAdMinAdapter;
...
public class BillADMiNActivity extends AppCompatActivity implements BillView {
    ...
    private BillAdMinAdapter hoaDonAdapter;
    @Override
    ...
    private void Init() {
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                billPreSenter.HandleReadDataHD(position);
            }
    ...
    private void DiaLogUpDate(int pos) {
        ...
        spiner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                       if(position>0){
                           billPreSenter.CapNhatTrangThai(4,arrayList.get(pos).getId());
                           dialog.cancel();
                       }
            }
    ...
    public void getDataHD(String id, String uid, String diachi, String hoten, String ngaydat, String phuongthuc, String sdt, Long tongtien, Long type) {
        ...
        hoaDonAdapter = new BillAdMinAdapter(this,arrayList,5);
    ...
    public void OnSucess() {
        ...
        billPreSenter.HandleReadDataHD(0);
    }
}
