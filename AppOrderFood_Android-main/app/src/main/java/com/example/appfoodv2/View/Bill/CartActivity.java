...
import com.example.appfoodv2.Adapter.CartAdapter;
...
public class CartActivity extends AppCompatActivity implements CartView {
    ...
    private CartAdapter sanPhamAdapter;
    ...
    private void Init() {
        ...
        cartPreSenter.HandlegetDataGioHang();
            ...
            public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
                ...
                buidler.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        cartPreSenter.HandlegetDataGioHang(arrayList.get(pos).getId());
...
//Dien thong tin đặt hàng
    private void CustomInit(Dialog dialog) {
        ...
        tongtien = 0 ;
            ...
            for (ProductModels productModels : arrayList) {
                tongtien += productModels.getGiatien()  * productModels.getSoluong();
            }
                    ...
                    if(diachi.length()>0){
                        if(sdt.length()>0){
                            ...
                            switch (spinner.getSelectedItemPosition()){
                                case 0:
                                    cartPreSenter.HandleAddHoaDon(ngaydat,diachi,hoten,sdt,phuongthuc,tongtien,arrayList);
                                    dialog.cancel();break;
                                case 1:
    ...
    public void getDataSanPham(String id, String idsp,String tensp, Long giatien, String hinhanh, String loaisp, Long soluong, String hansudung, Long type, String trongluong) {
        try{
            ...
            sanPhamAdapter = new CartAdapter(CartActivity.this,arrayList,1);
    ...
    private void requestPayment() {
        ...
        try {
            ...
            String name ="";
            for(ProductModels sanPham : arrayList){
        ...
        if(requestCode == AppMoMoLib.getInstance().REQUEST_CODE_MOMO && resultCode == -1) {
            ...
            if(data != null) {
                ...
                if(data.getIntExtra("status", -1) == 0) {
                    ...
                    cartPreSenter.HandleAddHoaDon(simpleDateFormat.format(calendar.getTime()),diachi,hoten,sdt,spinner.getSelectedItem().toString(),tongtien,arrayList);
                    progressBar.setVisibility(View.GONE);
