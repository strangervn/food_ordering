...
import com.example.appfoodv2.Presenter.ProductPreSenter;
import com.example.appfoodv2.Presenter.ProductView;
import com.example.appfoodv2.R;

import java.util.ArrayList;

public class FragMent_Home  extends Fragment implements ProductView {
    View view;
    private ArrayList<String> arrayList;
    private ViewPager viewPager;
    private FirebaseFirestore db;
    private BannerAdapter bannerAdapter;
    private ProductPreSenter sanPhamPreSenter;
    private  ArrayList<ProductModels> arr_sp,arr_sp_nb,arr_sp_tu,arr_sp_hq,arr_sp_mc,arr_sp_yt,arr_sp_lau,arr_sp_gy;
    private ProductAdapter productAdapter,sanPhamNBAdapter,sanPhamTUAdapter,sanPhamHQAdapter,sanPhamMCAdapter,sanPhamYTAdapter,sanPhamLauAdapter,sanPhamGYAdapter;
    ...
    private void InitSanPham() {
        ...
        sanPhamPreSenter = new ProductPreSenter(this);
...
///Tạo banner
    ...
    public void getDataSanPham(String id, String tensp, Long giatien, String hinhanh, String loaisp, String mota, Long soluong,
        ...
        arr_sp.add(new ProductModels(id,tensp,giatien,hinhanh,loaisp,mota,soluong,nhasanxuat,type,trongluong));
        productAdapter = new ProductAdapter(getContext(),arr_sp);
        rcvSP.setLayoutManager(new LinearLayoutManager(getContext(),RecyclerView.HORIZONTAL,false));
        rcvSP.setAdapter(productAdapter);
    ...
    public void getDataSanPhamNB(String id, String tensp, Long giatien, String hinhanh, String loaisp, String mota, Long soluong, String nhasanxuat, Long type, String trongluong) {
        arr_sp_nb.add(new ProductModels(id,tensp,giatien,hinhanh,loaisp,mota,soluong,nhasanxuat,type,trongluong));
        sanPhamNBAdapter = new ProductAdapter(getContext(),arr_sp_nb,2);
    ...
    public void getDataSanPhamTU(String id, String tensp, Long giatien, String hinhanh, String loaisp, String mota, Long soluong, String nhasanxuat, Long type, String trongluong) {
        arr_sp_tu.add(new ProductModels(id,tensp,giatien,hinhanh,loaisp,mota,soluong,nhasanxuat,type,trongluong));
        sanPhamTUAdapter = new ProductAdapter(getContext(),arr_sp_tu,3);
    ...
    public void getDataSanPhamHQ(String id, String tensp, Long giatien, String hinhanh, String loaisp, String mota, Long soluong, String nhasanxuat, Long type, String trongluong) {
        arr_sp_hq.add(new ProductModels(id,tensp,giatien,hinhanh,loaisp,mota,soluong,nhasanxuat,type,trongluong));
        sanPhamHQAdapter = new ProductAdapter(getContext(),arr_sp_hq,4);
    ...
    public void getDataSanPhamMC(String id, String tensp, Long giatien, String hinhanh, String loaisp, String mota, Long soluong, String nhasanxuat, Long type, String trongluong) {
        arr_sp_mc.add(new ProductModels(id,tensp,giatien,hinhanh,loaisp,mota,soluong,nhasanxuat,type,trongluong));
        sanPhamMCAdapter = new ProductAdapter(getContext(),arr_sp_mc,5);
    ...
    public void getDataSanPhamYT(String id, String tensp, Long giatien, String hinhanh, String loaisp, String mota, Long soluong, String nhasanxuat, Long type, String trongluong) {
        arr_sp_yt.add(new ProductModels(id,tensp,giatien,hinhanh,loaisp,mota,soluong,nhasanxuat,type,trongluong));
        sanPhamYTAdapter = new ProductAdapter(getContext(),arr_sp_yt,6);
    ...
    public void getDataSanPhamLau(String id, String tensp, Long giatien, String hinhanh, String loaisp, String mota, Long soluong, String nhasanxuat, Long type, String trongluong) {
        arr_sp_lau.add(new ProductModels(id,tensp,giatien,hinhanh,loaisp,mota,soluong,nhasanxuat,type,trongluong));
        sanPhamLauAdapter = new ProductAdapter(getContext(),arr_sp_lau,7);
    ...
    public void getDataSanPhamGY(String id, String tensp, Long giatien, String hinhanh, String loaisp, String mota, Long soluong, String nhasanxuat, Long type, String trongluong) {
        arr_sp_gy.add(new ProductModels(id,tensp,giatien,hinhanh,loaisp,mota,soluong,nhasanxuat,type,trongluong));
        sanPhamGYAdapter = new ProductAdapter(getContext(),arr_sp_gy,8);
