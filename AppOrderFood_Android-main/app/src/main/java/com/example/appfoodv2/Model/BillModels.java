...
import com.example.appfoodv2.Presenter.IBill;

import java.io.Serializable;

public class BillModels implements Serializable {
    ...
    private  long type;
    private IBill callback;
    private FirebaseFirestore db;

    public BillModels(IBill callback) {
    ...
    public BillModels(String id, String uid, String diachi, String hoten, String ngaydat, String phuongthuc, String sdt, long tongtien, long type) {
        this.id = id;
        this.uid = uid;
        this.diachi = diachi;
        this.hoten = hoten;
